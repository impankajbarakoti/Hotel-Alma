    ...
    <div className="min-h-screen bg-stone-100">
      ...
      <div className="py-6 px-4 sm:px-6 md:px-10 lg:px-16">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8">
          ...
          <article className="lg:col-span-3 bg-white p-4 sm:p-6 rounded-lg shadow-md">
            <img
              ...
              loading="lazy"
            />
            <h1 className="text-2xl sm:text-3xl font-bold text-stone-500 mb-3 sm:mb-4">
              {blog.title}
            </h1>
          ...
          <aside className="space-y-3 sm:space-y-4 mt-10 lg:mt-0">
            <h2 className="text-lg sm:text-xl font-semibold text-stone-500">
              Random Blogs
            </h2>
            {randomBlogs.map((b) => (
              <div
              ...
              >
                ...
                <div className="ml-2 sm:ml-3 overflow-hidden">
                  <h4 className="text-xs sm:text-sm font-semibold text-stone-500 truncate">
                    {b.title}
                  </h4>
        ...
        <div className="max-w-7xl mx-auto mt-8 sm:mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
          {/* Latest Post */}
          <div>
            <h2 className="text-lg sm:text-xl font-semibold text-stone-500 mb-3 sm:mb-4">
              Latest Post
            </h2>
            {hasLatest ? (
              <div
              ...
              >
                ...
                <div className="sm:ml-5">
                  <h4 className="text-base sm:text-lg font-semibold text-stone-500 break-words">
                    {latestPost.title}
                  </h4>
              ...
              moreBlogs.map((b) => (
                ...
                >
                  ...
                  <div className="ml-2 sm:ml-4 overflow-hidden">
                    <h4 className="text-sm sm:text-base font-semibold text-stone-500 truncate">
                      {b.title}
                    </h4>
